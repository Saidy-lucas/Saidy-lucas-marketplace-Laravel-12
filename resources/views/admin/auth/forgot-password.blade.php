            ...
            <div class="card card-primary">
              ...
              @if(session('status'))
               <p class="alert alert-info">
                  Link de recuperação enviado ao seu email!
                </p>
              @endif()
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('password.email') }}" class="needs-validation" novalidate="">
                  ...
                  <p style="text-align:center; "><a href="{{ route('admin.login') }}" title="voltar para o login" style="color: #424040;">Voltar ao login</a></p>
                </form>
              </div>
            </div>
