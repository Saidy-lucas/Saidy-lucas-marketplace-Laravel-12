...
<body style="background-color: rgb(33, 28, 93);">
  <div id="app">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control" name="password" placeholder="Senha" tabindex="2" value="{{ old('') }}" required>
            ...
            <div class="mt-5 text-muted text-center">
              Não tem uma conta? <a href="auth-register.html">Criar</a>
            </div>
            <div class="simple-footer">
              Desenvolvido por Olulwo
            </div>
            <div class="simple-footer">
              Todos os direitos reservados &copy; Olulwo <?= date('Y') ?>
            </div>
          </div>
        </div>
      </div>
